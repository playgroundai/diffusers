...
class StableDiffusionXLImg2ImgPipeline(
    ...
    def prepare_latents(
        ...
        if image.shape[1] == 4:
            ...
            if isinstance(generator, list) and len(generator) != batch_size:
                ...
                init_latents = [
                    retrieve_latents(self.vae_runner.model.encode(image[i : i + 1]), generator=generator[i])
    ...
    def _get_add_time_ids(
        ...
        # [Tyler] After call with Spectral, this error code is vestigial. The optimized model does not use the same unet.
        #         ref: T-5193 Speed up all img2img requests
        ...
        with swap_scheduler(self, monkeypatched_scheduler):
            ...
            with self.progress_bar(total=num_inference_steps) as progress_bar:
                for i, t in enumerate(timesteps):
                    ...
                    self.ref_unetxl_engine.copy_into_tensor("sample", latent_model_input * c_in)
                    self.ref_unetxl_engine.copy_into_tensor("timestep", c_noise)
