...
class StableDiffusionXLImg2ImgPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.ref_unetxl_engine.set_tensor("encoder_hidden_states", prompt_embeds)
        self.ref_unetxl_engine.set_tensor("text_embeds", add_text_embeds)
        self.ref_unetxl_engine.set_tensor("time_ids", add_time_ids)
